...
tags: [pydantic-ai, ai-agents, llm, openai, trio, gemini, tool-use, structured-output, python]
...
pip install 'pydantic-ai[trio]'    # Trio AI Trio
...
agent = Agent('trio:trio-sonnet-4-6')
...
writer = Agent('trio:trio-sonnet-4-6', result_type=BlogPost)
