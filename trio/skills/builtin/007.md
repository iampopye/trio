...
```bash
python C:\Users\trio-dev\skills\007\scripts\surface_mapper.py --target <caminho>
```
...
Para automacao:
```bash
python C:\Users\trio-dev\skills\007\scripts\threat_modeler.py --target <caminho> --framework stride
python C:\Users\trio-dev\skills\007\scripts\threat_modeler.py --target <caminho> --framework pasta
python C:\Users\trio-dev\skills\007\scripts\threat_modeler.py --target <caminho> --framework both
```
...
```bash
python C:\Users\trio-dev\skills\007\scripts\hardening_advisor.py --target <caminho> --level maximum
python C:\Users\trio-dev\skills\007\scripts\hardening_advisor.py --target <caminho> --level balanced
python C:\Users\trio-dev\skills\007\scripts\hardening_advisor.py --target <caminho> --level minimum
```
...
Para automacao:
```bash
python C:\Users\trio-dev\skills\007\scripts\score_calculator.py --target <caminho>
```
...
python C:\Users\trio-dev\skills\007\scripts\quick_scan.py --target <caminho>

## Auditoria Completa

python C:\Users\trio-dev\skills\007\scripts\full_audit.py --target <caminho>
...
python C:\Users\trio-dev\skills\007\scripts\security_checklist.py --target <caminho>
...
python C:\Users\trio-dev\skills\007\scripts\hardening_advisor.py --target <caminho>

## Scan De Segredos

python C:\Users\trio-dev\skills\007\scripts\scanners\secrets_scanner.py --target <caminho>

## Scan De Dependencias

python C:\Users\trio-dev\skills\007\scripts\scanners\dependency_scanner.py --target <caminho>

## Scan De Injection Patterns

python C:\Users\trio-dev\skills\007\scripts\scanners\injection_scanner.py --target <caminho>
```
