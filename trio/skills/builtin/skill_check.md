---
name: skill-check
description: "Validate Trio skills against the agentskills specification. Catches structural, semantic, and naming issues before users do."
...
tools: [trio, cursor, windsurf, codex-cli]
license: MIT
allowed-tools: Read Glob
compatibility: trio-code
---
...
Validate SKILL.md files against the [agentskills specification](https://agentskills.io) and Trio AI best practices. Catches structural errors, semantic contradictions, naming anti-patterns, and quality gaps in a single read-only pass.
...
```
User: check my skill at ~/.trio/skills/weekly-report/SKILL.md
...
```
User: skillcheck ~/.trio/skills/processing-pdfs/SKILL.md
