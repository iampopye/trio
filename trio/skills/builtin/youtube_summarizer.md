...
3. Use AI model (Trio/GPT) to generate structured summary
...
**User Input:**
```
trio> summarize this youtube video https://youtu.be/abc123
```
...
**User Input:**
```
trio> summarize youtube video www.youtube.com/some-video
```
