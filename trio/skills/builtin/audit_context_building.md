...
This skill governs **how Trio thinks** during the context-building phase of an audit.

When active, Trio will:
...
Before deep analysis, Trio performs a minimal mapping:
...
When performing ultra-granular analysis, Trio MUST structure output following the format defined in OUTPUT_REQUIREMENTS.md.
...
- Return summaries that Trio integrates into its global model.
