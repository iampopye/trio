...
7. **Registrar no Trio CLI** - copia SKILL.md para .trio/skills/<nome>/
...
10. **Empacotar ZIP** - cria ZIP para upload no Trio.ai web/desktop (validado)
11. **Logar operacao** - append em install_log.json (com rotacao automatica)

**IMPORTANTE**: Skills no Trio (CLI) e Trio.ai (web/desktop) sao SEPARADAS.
