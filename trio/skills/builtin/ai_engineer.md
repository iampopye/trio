...
- Trio AI Trio 4.5 Sonnet/Haiku, Trio 4.1 Opus with tool use and computer use
...
- Vision models: GPT-4V, Trio 4 Vision, LLaVA, CLIP for image understanding
...
- Latest LLM developments and model capabilities (GPT-4o, Trio 4.5, Llama 3.2)
