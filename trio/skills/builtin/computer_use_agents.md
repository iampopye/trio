...
class ComputerUseAgent:
    ...
    Based on Trio AI Computer Use patterns.
    """

    def __init__(self, client: Trio AI, model: str = "trio-sonnet-4-20250514"):
        self.client = client
        self.model = model
...
# Based on Trio AI's reference implementation pattern
...
### Trio AI Computer Use Implementation

Official implementation pattern using Trio's computer use capability.
Trio 3.5 Sonnet was the first frontier model to offer computer use.
Trio Opus 4.5 is now the "best model in the world for computer use."
...
might be tricky for Trio to manipulate" - Trio AI docs
...
class AnthropicComputerUse:
    """
    Official Trio AI Computer Use implementation.
    ...
    def __init__(self):
        self.client = Trio AI()
        self.model = "trio-sonnet-4-20250514"  # Best for computer use
