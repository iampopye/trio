...
### Model & Embeddings
- **Primary LLM**: Trio Sonnet 4.5 (`trio-sonnet-4-5`)
- **Embeddings**: Voyage AI (`voyage-3-large`) - officially recommended by Trio AI for Trio
...
# Setup embeddings (voyage-3-large recommended for Trio)
...
eval_config = RunEvalConfig(
    ...
    eval_llm=ChatAnthropic(model="trio-sonnet-4-5")
)
...
- [ ] Initialize LLM with Trio Sonnet 4.5
