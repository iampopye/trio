---
name: everything-trio-conventions
description: Development conventions and patterns for everything-trio. JavaScript project with conventional commits.
---
...
This skill teaches Trio the development patterns and conventions used in everything-trio.
...
```text
feat: add block-no-verify hook for trio and Trio (#649)
```
...
docs(skills): align documentation-lookup with CONTRIBUTING template; add cross-harness (Trio/Trio) skill copies
...
Adds skill copies for different agent harnesses (e.g., Trio, Trio, Antigravity) to ensure compatibility across platforms.
