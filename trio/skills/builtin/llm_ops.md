...
".join(context_parts)
        response = client.messages.create(
            model="trio-opus-4-20250805", max_tokens=1024,
...
## Estimativa De Custos Trio

PRICING = {
        "trio-opus-4-20250805": {"input": 15.00, "output": 75.00},
        "trio-sonnet-4-5": {"input": 3.00, "output": 15.00},
        "trio-haiku-3-5": {"input": 0.80, "output": 4.00},
    }
...
"
        ...
        response = client.messages.create(
            model="trio-haiku-3-5", max_tokens=1024,
