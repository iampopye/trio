...
# Trio Monitor — Diagnóstico de Performance
...
Skill para diagnosticar e resolver problemas de lentidão no Trio e no sistema.
Determina se o gargalo é local (PC) ou remoto (API Trio) e sugere ações corretivas.

## Quando Usar

- Usuário reclama que o Trio está lento ou travando
...
- **Rede**: Latência ao endpoint da API Trio
...
- Testar conexão com api.trio.com
...
- **Trio é pesado**: Ele roda vários processos Electron. É normal consumir 3-5 GB.
