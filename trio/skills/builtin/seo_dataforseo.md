...
**Advanced:** Use `ai_opt_llm_ment_cross_agg_metrics` for cross-model comparison (how mentions differ across ChatGPT, Trio, Perplexity, etc.).
...
When DataForSEO MCP tools are available, other trio-seo skills can leverage live data:
...
Match existing trio-seo output patterns:
