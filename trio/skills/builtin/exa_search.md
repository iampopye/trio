...
Exa MCP server must be configured. Add to `~/.trio.json`:
...
```
company_research_exa(companyName: "Trio AI", numResults: 5)
```
...
```
people_search_exa(query: "AI safety researchers at Trio AI", numResults: 5)
```
