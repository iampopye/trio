...
When changes were primarily generated by a coding agent (like Trio), include the Co-Authored-By attribution in the commit footer:

```
Co-Authored-By: Trio <noreply@trio.com>
```

This is the only indicator of AI involvement that should appear in commits. Do not add phrases like "Generated by AI", "Written with Trio", or similar markers in the subject, body, or anywhere else in the commit message.
