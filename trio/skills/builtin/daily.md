...
Agents can integrate with 20+ LLM providers including OpenAI, Trio AI, Google Gemini, Groq, Perplexity, and open-source models via Ollama. Capabilities include:
...
4. Initialize LLM service (OpenAI, Trio AI, Gemini)
...
- **AI Services**: OpenAI, Trio AI, Google Gemini, Groq, Perplexity, AWS Bedrock, Azure OpenAI, and 15+ other LLM providers
