...
def main():
    ...
    if args.command == "help":
        from triobot.cli.help_cmd import run_help
        asyncio.run(run_help(args.topic))

    elif args.command == "onboard":
        from triobot.cli.onboard import run_onboard
        ...
        from triobot.cli.gateway import run_gateway
        asyncio.run(run_gateway())

    elif args.command == "provider":
        from triobot.cli.provider_cmd import run_provider
        asyncio.run(run_provider(args.provider_action))

    elif args.command == "status":
        from triobot.cli.status import run_status
        asyncio.run(run_status())

    elif args.command == "heartbeat":
        from triobot.cli.heartbeat_cmd import run_heartbeat
        asyncio.run(run_heartbeat(args.hb_action))

    elif args.command == "plugin":
        from triobot.cli.plugin_cmd import run_plugin
        asyncio.run(run_plugin(args))

    elif args.command == "skill":
        from triobot.cli.skill_cmd import run_skill
        ...
        from triobot.cli.update_cmd import run_update
        ...
        from triobot.cli.repo_cmd import run_repo
        asyncio.run(run_repo(args))

    elif args.command == "serve":
        from triobot.web.app import run_server
