...
from triobot.core.config import (
...
def _setup_local_gguf(config: dict):
    ...
    from triobot.providers.local import _find_gguf_model, _list_gguf_models
...
def _step_system_check() -> None:
    """Step 1/6: System Check -- uses triobot.core.hardware for auto-detection."""
