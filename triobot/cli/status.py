...
from triobot.core.config import load_config, get_config_path, get_trio_dir
...
from triobot.core.rag import RAGStore
...
async def run_status():
    ...
    try:
        from triobot.tools.base import register_builtins
