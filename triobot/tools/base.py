...
class ToolRegistry:
    ...
    def register_builtins(self, config: dict) -> None:
        ...
        if "web_search" in enabled:
            try:
                from triobot.tools.web_search import WebSearchTool
        ...
        if "math_solver" in enabled:
            try:
                from triobot.tools.math_solver import MathSolverTool
