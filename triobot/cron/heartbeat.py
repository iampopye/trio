...
Integrates with :class:`triobot.cron.daemon.TrioDaemon` for background execution.
...
from triobot.core.bus import InboundMessage, MessageBus
...
class HeartbeatDaemon:
    ...
    log_path:
        ...
        inside :class:`~triobot.cron.daemon.TrioDaemon`, the daemon passes
