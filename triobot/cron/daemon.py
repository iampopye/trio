...
from triobot.core.config import get_trio_dir, load_config, get_agent_defaults
...
class TrioDaemon:
    ...
    def _register_channels(self) -> None:
        ...
        channel_defs: list[tuple[str, str, str]] = [
            ("discord", "triobot.channels.discord_channel", "DiscordChannel"),
            ("telegram", "triobot.channels.telegram_channel", "TelegramChannel"),
            ("signal", "triobot.channels.signal_channel", "SignalChannel"),
            ("whatsapp", "triobot.channels.whatsapp_channel", "WhatsAppChannel"),
            ("slack", "triobot.channels.slack_channel", "SlackChannel"),
            ("teams", "triobot.channels.teams_channel", "TeamsChannel"),
            ("google_chat", "triobot.channels.google_chat_channel", "GoogleChatChannel"),
            ("imessage", "triobot.channels.imessage_channel", "IMessageChannel"),
        ]
