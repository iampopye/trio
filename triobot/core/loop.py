...
from triobot.core.approvals import ApprovalManager, ApprovalPolicy
from triobot.core.bus import InboundMessage, OutboundMessage, StreamChunk, MessageBus
from triobot.core.config import get_agent_defaults, get_workspace_dir
from triobot.core.context import build_system_prompt, build_messages
from triobot.core.memory import MemoryStore
from triobot.core.router import ModelRouter
from triobot.core.session import Session, SessionManager
from triobot.providers.base import BaseProvider, LLMResponse
from triobot.shared.guardrails import check_input, filter_output
from triobot.shared.think_parser import ThinkTagParser
from triobot.core.subagent import SubAgentRegistry, register_default_subagents
...
class AgentLoop:
    ...
    def __init__(
        ...
        # Load skills
        from triobot.skills.loader import SkillsLoader
        self._skills = SkillsLoader()
        self._skills.load_all()

        # Load plugins
        try:
            from triobot.plugins.loader import PluginLoader
            from triobot.core.config import get_plugins_dir
        ...
        if "delegate" in enabled_tools:
            from triobot.tools.subagent_tool import SubAgentTool
    ...
    async def _execute_tool_with_approval(
        ...
        """
        from triobot.tools.base import ToolResult
