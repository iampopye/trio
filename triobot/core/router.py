...
from triobot.providers.base import BaseProvider, ProviderRegistry, register_all_providers
...
class ModelRouter:
    ...
    async def _check_api_provider(self, name: str, status: ProviderStatus) -> ProviderStatus:
        ...
        from triobot.providers.openai_compat import KNOWN_PROVIDERS as API_BASES
