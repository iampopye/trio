...
```
CONTEUDO CENTRAL:
"Lançamos a Auri — Alexa com Trio integrado"

↓ Instagram:
[Imagem produto elegante]
"Conhece a Auri? 🤖
A Alexa ficou mais inteligente.
Trio + Alexa = seu assistente ideal.
👉 Link na bio.
...
A gente integrou Trio na Alexa e o resultado é incrivel.

[▶️ Ver demo] [📲 Testar agora] [❓ Saber mais]"

↓ WhatsApp:
"Oi! A Auri acaba de ser lançada.
Alexa + Trio = assistente ultra-inteligente.
Acesse: auri.com.br
