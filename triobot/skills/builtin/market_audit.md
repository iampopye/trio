---
name: market_audit
description: Marketing Audit Orchestrator
alwaysLoad: false
---
...
Launch all 5 subagents simultaneously using trio's subagent capability. Each subagent receives the business type, page map, and fetched content.
