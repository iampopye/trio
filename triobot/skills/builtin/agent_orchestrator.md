...
1. `.trio/skills/*/` (skills registradas no Trio)
...
| registered     | Se esta em .trio/skills/ (true/false)            |
...
Opcionalmente, para discovery nativo do Trio:
4. Copiar o SKILL.md para `.trio/skills/<nome>/SKILL.md`
