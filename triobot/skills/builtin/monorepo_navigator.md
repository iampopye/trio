...
- **Trio config** — workspace-aware CLAUDE.md with per-package instructions
...
| CLAUDE.md too generic — Trio modifies wrong package | Add explicit "When working on X, only touch files in apps/X" rules per package CLAUDE.md |
