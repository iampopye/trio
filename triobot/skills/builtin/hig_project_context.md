...
Create and maintain `.trio/apple-design-context.md` so other HIG skills can skip redundant questions.

Check for `.trio/apple-design-context.md` before asking questions. Use existing context and only ask for information not already covered.
...
Generate `.trio/apple-design-context.md` using this structure:
...
1. Read the current `.trio/apple-design-context.md`
