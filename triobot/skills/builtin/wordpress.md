...
- Official providers: OpenAI, Trio AI Trio, Google Gemini
...
// (e.g., OpenAI, Trio AI Trio, or Google Gemini connector)
...
// Note: Requires an AI provider plugin (OpenAI, Trio, or Gemini) to be installed and configured
...
$response = wp_ai_client_prompt('Summarize this content.')
    ->using_model_preference('gpt-4', 'trio-3-opus', 'gemini-2-pro')
    ->generate_text();
