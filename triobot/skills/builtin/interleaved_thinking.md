...
Analyze any agent's previous thinking (works with Trio, GPT, etc.):

When this skill is activated in Trio, it can analyze the current session's thinking blocks to identify issues and suggest improvements.
